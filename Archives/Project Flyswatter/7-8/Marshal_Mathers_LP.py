...
UDP_Destination_IP = "239.255.255.255"  # Multicast
UDP_Source_PORT = 45000
UDP_Destination_PORT = 45000

# Initialize the UDP socket
sock = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)  # UDP
sock.bind((UDP_Source_IP, UDP_Source_PORT))
                        ...
                        if ser.in_waiting > 0:
                            ...
                            if "GGA" in data:
                                ...
                                if marshall_message != -1:
                                    ...
                                    # Send the Marshall message to the UDP socket
                                    sock.sendto(marshall_message, (UDP_Destination_IP, UDP_Destination_PORT))
...
def convert_NMEA_to_Marshall(GGA_NMEA_String, Tail_Number=1):
    ...
    try:
        ...
        Platform_Tail_Number_Tag_Value = ("BIRD_" + str(Tail_Number).rjust(2, "0")).encode("utf-8").hex().ljust(18, "0")
